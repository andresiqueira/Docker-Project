...
const SearchBar = ({ setData, ...rest }: SearchBarProps) => {
  ...
  return (
    <form
      ...
      className="flex relative flex-row items-center justify-between rounded-[0.1875rem] ml-[0.625rem] w-[33.125rem] border border-primary-border h-10 shadow-primary-shadow px-3"
      {...rest}
    >
